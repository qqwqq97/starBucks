                ...
                <main id="main">
                        <section id="section1">
                            <div className="container">
                                <span className="ani ani1"><img src="./img/2022_m_NewYear_main_slogan.png" alt=""/></span>
                        ...
                        <div className="container">
                            <div className="left">{/* <!--relative--> */}
                                <div className="left-wrap"> {/* <!--높이--> */}
                                    <div className="notice-title">
                                        <h2 className="blind">공지사항</h2>
                                    </div> 
                                    <div className="notice-list"> 
                                        <ul>
                                            <li className="notice-slide">
                                                <a href="#">Gift배송하기 서비스 배송지연 안내</a>
                                            </li>
                                            <li className="notice-slide">
                                                <a href="#">홈페이지 이용약관 / 스타벅스 카드 이용약관 개정 안내</a>
                                            </li>
                                            <li className="notice-slide">
                                                <a href="#">제25기 정기주주총회 권리행사 기준일 공고</a>
                                            </li>
                                            <li className="notice-slide">
                                                <a href="#">시스템 개선 및 점검 안내</a>
                                            </li>
                                            <li className="notice-slide">
                    ...
                    <section id="section4">
                        <div className="container">
                            <div className="left">
                                <img src="./img/rewards-logo.png" alt="reward-logo"/>
                            </div>
                            <div className="right">
                                <div className="top">
                                    <h2><span>스타벅스만의 특별한 혜택,</span><strong>스타벅스 리워드</strong></h2>
                                    <div>
                                        <h3 className="pc">
                                ...
                                <div className="bottom">
                                        ...
                                        <span><a href="#" className="gift-card">e-Gift Card 선물하기</a></span>
                                </div>
                            </div>
                        </div>
                    </section>                    
                    <section id="section5">
                        <div className="container">
                            <div className="left">
                                <img src="./img/2022_NewYear_bean_bean.png" alt="NewYear_been_bean"/>
                            </div>
                            <div className="right">
                                <span>
