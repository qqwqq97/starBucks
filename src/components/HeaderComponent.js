                            ...
                            <div className="bottom">
                                <nav id="nav" className="clearfix">
                                    <ul className="clearfix">
                                        ...
                                        <li>
                                            ...
                                            <div className="sub sub2">
                                                <div className="top">
                                                    <div className="sub-container">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <dl>
                                                                    <dt><a href="#x">메뉴 이야기</a></dt>
                                                                    <dd><a href="#x">나이트로 콜드브루</a></dd>
                                                                    <dd><a href="#x">콜드 브루</a></dd>
                                                                    <dd><a href="#x">스타벅스 티바나</a></dd>
                                                ...
                                                <div className="bottom">
                                                    <div className="sub-container">
                                                        <dl>
                                                            <dt><a href="#">나이트로 콜드 브루 <img src="./img/icon_gnb_new.png" alt="newicon"/> </a></dt>
                                        ...
                                        <li><a href="#" className="main-btn">STORE</a>
                                        ...
                                        <li><a href="#" className="main-btn">RESPONSIBILITY</a>
                                        ...
                                        <li><a href="#" className="main-btn">STARBUCKS REWARDS</a>
                                        ...
                                        <li><a href="#" className="main-btn">WHAT'S NEW</a>
